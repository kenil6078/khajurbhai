...
const Page5 = () => {
  return (
  <>
  <div className='capsules flex items-start justify-between gap-10 w-full h-screen mt-60 px-32 bg-[#FEE685] text-white'>
    ...
    <div className="right flex h-full gap-15 items-center">
      <div className="capsul -rotate-[16deg] flex flex-col items-center px-6 py-10 rounded-full border-[3px] border-white">
        <div className='w-[16rem] h-[16rem] rounded-full overflow-hidden bg-purple-200'>
          <img className='h-full w-full object-cover' src="./khajur-4.jpg" alt="" />
        </div>
     ...
     <div className="capsul -rotate-[16deg] flex flex-col-reverse items-center py-10 px-6 rounded-full border-[3px] border-white">
        <div className='w-[16rem] h-[16rem] rounded-full overflow-hidden bg-purple-200'>
          <img className='h-full w-full object-cover' src="./khajur-5.jpg" alt="" />
        </div>
        <div className="text text-center mt-14">
          <h3 className='text-2xl font-medium'>Equity in Tech: An</h3>
          <h3 className='text-2xl font-medium'>International Empower's</h3>
